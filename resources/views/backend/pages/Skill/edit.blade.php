          ...
          <input type="hidden" name="id" value="{{ $data->id }}">
            <div class="border p-3 rounded">
              ...
              <div class="mb-3">
                ...
                <input type="text" required class="form-control" name="number" value="{{ $data->number }}">
              </div>
              <div class="mb-3">
                <select name="status" class="from-control" required id="">
                    <option @if ($data->status==1) selected @endif  value="1">Frontend</option>
                    <option @if ($data->status==2) selected @endif  value="2">Backend</option>
                </select>
              </div>
              <div class="mb-3">
